...
#        self.event_ids  = np.array(self.h5_file["event_ids"])
        ...
        self.xvert = (np.ravel(self.h5_file["positions"][:,:,0]))/1800
        self.yvert = (np.ravel(self.h5_file["positions"][:,:,1]))/1800
        self.zvert = (np.ravel(self.h5_file["positions"][:,:,2]))/1800
...
#            self.veto2 = np.array(self.h5_file["veto2"])
    ...
    def __getitem__(self, item):
        ...
        data_dict = {
            ...
            "xvert": self.xvert[item].astype(np.float32),
